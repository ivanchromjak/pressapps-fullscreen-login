...
window.Modernizr = function(a, b, c) {
    ...
    function H() {
        ...
        e.inputtypes = function(a) {
            for (var d = 0, e, g, h, i = a.length; d < i; d++) j.setAttribute("type", g = a[d]), 
            e = j.type !== "text", e && (j.value = k, j.style.cssText = "position:absolute;visibility:hidden;", 
            /^range$/.test(g) && j.style.WebkitAppearance !== c ? (f.appendChild(j), h = b.defaultView, 
    ...
    var d = "2.8.3", e = {}, f = b.documentElement, g = "modernizr", h = b.createElement(g), i = h.style, j = b.createElement("input"), k = ":)", l = {}.toString, m = " -webkit- -moz- -o- -ms- ".split(" "), n = "Webkit Moz O ms", o = n.split(" "), p = n.toLowerCase().split(" "), q = {}, r = {}, s = {}, t = [], u = t.slice, v, w = function(a, c, d, e) {
        ...
        function d(d, e) {
            ...
            f = C(e[d], "function"), C(e[d], "undefined") || (e[d] = c), e.removeAttribute(d))), 
            e = null, f;
        }
        var a = {
            select: "input",
    ...
    return e.input || H(), e.addTest = function(a, b) {
        ...
        return e;
    }, A(""), h = j = null, e._version = d, e._prefixes = m, e._domPrefixes = p, e._cssomPrefixes = o, 
    e.hasEvent = x, e.testProp = function(a) {
        return E([ a ]);
    }, e.testAllProps = G, e.testStyles = w, e.prefixed = function(a, b, c) {
        return b ? G(a, b, c) : G(a, "pfx");
    }, e;
}(this, this.document), Modernizr.addTest("cors", !!(window.XMLHttpRequest && "withCredentials" in new XMLHttpRequest())), 
...
Modernizr.addTest("filereader", function() {
    ...
    return a.id = d, document.createAttribute && (e = document.createAttribute("form"), 
    e.nodeValue = d, b.setAttributeNode(e), c.appendChild(a), c.appendChild(b), document.documentElement.appendChild(c), 
    f = a.elements.length === 1 && b.form == a, c.parentNode.removeChild(c)), f;
...
!function(a) {
    ...
    var c = function(b) {
    ...
    }("undefined" == typeof b ? function() {} : b), d = function() {
        function d(a, b) {
            if (a) {
        ...
        function j(a, b, c) {
            function d() {
                ...
                return g[J](f) ? (i(h, f), c ? c(g[f]) : g[f]) : (h.length >= 1e3 && delete g[h.shift()], 
                h.push(f), g[f] = a.apply(b, e), c ? c(g[f]) : g[f]);
            }
            return d;
        }
        ...
        function p(a, b) {
            ...
            if (c) for (var e = 0, f = c.length; f > e; e++) {
                ...
                h = q.y(0, 0), i = q.x(l[1], l[2]), j = q.y(l[1], l[2]), d.translate(i - g, j - h)) : d.translate(l[1], l[2]) : "r" == o ? 2 == m ? (k = k || b, 
        ...
        function q(a, b) {
            if (null == b) {
                ...
                !b) return new n();
                b = o(b);
            } else b = d._.rgTransform.test(b) ? K(b).replace(/\.{3}|\u2026/g, a._.transform || S) : o(b), 
        ...
        N.PI), S = (N.round, ""), T = " ", U = Object.prototype.toString, V = /^\s*((#[a-f\d]{6})|(#[a-f\d]{3})|rgba?\(\s*([\d\.]+%?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+%?(?:\s*,\s*[\d\.]+%?)?)\s*\)|hsba?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?%?)\s*\)|hsla?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?%?)\s*\))\s*$/i, W = /^url\(#?([^)]+)\)$/, X = "	\n\f\r   ᠎             　\u2028\u2029", Y = new RegExp("[," + X + "]+"), Z = (new RegExp("[" + X + "]", "g"), 
        new RegExp("[" + X + "]*,[" + X + "]*")), $ = {
            hs: 1,
            rg: 1
        ...
        d._.clone = h, d._.cacher = j, d.rad = l, d.deg = m, d.angle = k, d.is = f, d.snapTo = function(a, b, c) {
            ...
            a.add = function(a, b, c, d, e, f) {
                ...
                var e = -d[0][1], f = d[1][1];
                return 0 > f ? (a.rotate = m(N.acos(f)), 0 > e && (a.rotate = 360 - a.rotate)) : a.rotate = m(N.asin(e)), 
            ...
            d.hsb2rgb(b, c, e, g)) : j[6] ? (i = j[6].split(Z), b = L(i[0]), "%" == i[0].slice(-1) && (b /= 100), 
        ...
        d.color = function(a) {
            ...
            a.h = b.h, a.s = b.s, a.l = b.l, b = d.rgb2hsb(a), a.v = b.b) : (a = {
                hex: "none"
            }, a.r = a.g = a.b = a.h = a.s = a.v = a.l = -1, a.error = 1)), a.toString = nb, 
            a;
        ...
        d._.svgTransform2string = o, d._.rgTransform = new RegExp("^[a-z][" + X + "]*-?\\.?\\d", "i"), 
        d._.transform2matrix = p, d._unit2px = s;
        ...
        d._.getSomeDefs = r, d.select = function(a) {
            ...
            a.attr = function(a, c) {
                ...
                c.bbox = d.path.getBBox(d.path.map(b.realPath, b.matrix)), d._.box(c.bbox));
            };
            var j = function() {
                return this.string;
            };
            a.transform = function(a) {
                ...
                return null == a && (a = this.getBBox()), f(a, "object") && "x" in a && (b = a.y, 
                c = a.width, d = a.height, a = a.x), e(g.node, {
                    x: a,
                    y: b,
                    width: c,
                    height: d,
                ...
                return null == a && (a = this.getBBox()), f(a, "object") && "x" in a && (b = a.y, 
                c = a.width, d = a.height, g = a.refX || a.cx, h = a.refY || a.cy, a = a.x), e(i.node, {
            ...
            if (a = K(a), a.match(/^\s*<\s*svg(?:\s|>)/) || (a = "<svg>" + a + "</svg>", c = !1), 
    ...
    return d.plugin(function(a, b) {
        ...
        j.stroke = j.fill = "colour", b.prototype.equal = function(b, c) {
            ...
            a._.rgTransform.test(c) || (c = a._.svgTransform2string(c)), d(o, c, function() {
                return p.getBBox(1);
            });
        ...
        f.drag = function(c, d, e, f, g, h) {
            function i(i, j, k) {
                (i.originalEvent || i).preventDefault(), this._drag.x = j, this._drag.y = k, this._drag.id = i.identifier, 
                ...
                e && b.on("snap.drag.end." + this.id, e), b("snap.drag.start." + this.id, g || f || this, j, k, i);
            }
            if (!arguments.length) {
                var j;
                ...
                $(".pafl-modal-content #form").on("submit", function(e) {
                    ...
                    if (form_id === "login") {
                        $.ajax({
                            ...
                            data: {
                                action: "ajaxlogin",
                                // Calls our wp_ajax_nopriv_ajaxlogin
