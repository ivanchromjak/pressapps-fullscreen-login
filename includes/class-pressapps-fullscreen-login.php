...
class Pressapps_Fullscreen_Login {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Pressapps_Fullscreen_Login_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		...
		$this->plugin_name = 'pressapps-fullscreen-login';
		$this->version = '1.0.0';
	 ...
	 *
	 * - Pressapps_Fullscreen_Login_Loader. Orchestrates the hooks of the plugin.
	 * - Pressapps_Fullscreen_Login_i18n. Defines internationalization functionality.
	 * - Pressapps_Fullscreen_Login_Admin. Defines all hooks for the admin area.
	 * - Pressapps_Fullscreen_Login_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		...
		if ( ! class_exists( 'PAFL_Captcha' ) ){
			require_once trailingslashit( dirname( dirname(__FILE__) ) ) . 'public/lib/recaptcha/Captcha.php';
			require_once trailingslashit( dirname( dirname(__FILE__) ) ) . 'public/lib/recaptcha/Exception.php';
			require_once trailingslashit( dirname( dirname(__FILE__) ) ) . 'public/lib/recaptcha/Response.php';
		}

		if ( ! class_exists( 'Hybrid_Auth' ) ) {
			require_once trailingslashit( dirname( dirname(__FILE__) ) ) . 'public/lib/hybridauth/Hybrid/Auth.php' ;
		}
	 ...
	 *
	 * Uses the Pressapps_Fullscreen_Login_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Pressapps_Fullscreen_Login_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Pressapps_Fullscreen_Login_Loader    Orchestrates the hooks of the plugin.
	 */
